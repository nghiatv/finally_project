                        ...
                        <div class="row">
                            <div class="col-xs-12 col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" value="{{ $range or "" }}" name="date-range"
                                               class="form-control pull-right" id="daterange-btn">
                                    </div><!-- /.input group -->
                                </div><!-- /.form group -->
                            ...
                            <div class="col-xs-6 col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        @if($id)
                                            <a href="{{asset('/admin/product/'.$id.'?date-range=all')}}" class="btn btn-success">Xem
                                                toàn bộ</a>
                                        @endif
                                    </div>
                                </div>
                        ...
                        @if($list)
                            ...
                            @foreach($list as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ asset('/admin/orders/'.$item->po_id) }}"> {{ $item->purchase_order_name }}</a>
                                    </td>
                                    <td>
                                        <a href="{{ asset('/admin/store/'.$item->store_id) }}">{{ App\Store::findOrFail($item->store_id)->store_name }}</a>
                                    </td>
                                    <td>{{ $item->quantity }}</td>
                                    <td>{{ $item->amount }}</td>
                                </tr>
